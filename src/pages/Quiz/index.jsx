...
export const Quiz = () => {
	...
	const getButtonClass = (answer, index) =>
		!showFeedback
			? classNames(styles["answer-button"], styles["gradient-border"], styles["answer-button-normal"])
			: index === selectedAnswer
			? classNames(styles["answer-button"], answer.isCorrect ? styles["answer-selected-correct"] : styles["answer-selected-incorrect"])
			: classNames(styles["answer-button"], answer.isCorrect ? styles["answer-correct"] : styles["answer-incorrect"]);
