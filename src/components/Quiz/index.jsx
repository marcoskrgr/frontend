...
export const QuizScreen = () => {
	...
	const getButtonClass = (answer, index) => {
		...
		if (index === selectedAnswer) {
			return classNames(styles["answer-button"], answer.isCorrect ? styles["answer-selected-correct"] : styles["answer-selected-incorrect"]);
		}
		if (answer.isCorrect) {
	...
	return (
		<div className={styles["quiz-container"]}>
			...
			<main className={styles["quiz-main"]}>
				...
				{showFeedback && (
					<button className={styles["next-button"]} onClick={handleNextQuestion}>
						Próxima pergunta
					</button>
				)}
			</main>
